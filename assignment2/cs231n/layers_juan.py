...
def batchnorm_backward(dout, cache):
    ...
    dbeta = dout.sum(axis=0) #axis=cache['axis']
    dgamma = np.sum(dout * cache['z'], axis=0) #axis=cache['axis']
...
def batchnorm_backward_alt(dout, cache):
    ...
    dbeta = dout.sum(axis=0) #cache['axis']
    dgamma = np.sum(dout * cache['z'], axis=0) #cache['axis']
